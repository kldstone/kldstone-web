        ...
        <div className="py-16 border-b border-white/6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <div className="flex flex-col gap-3">
                {[
                  ...
                  <Link key={l.to} to={l.to} className="text-white/45 text-[13px] hover:text-[#b8873d] transition-colors">
                    {l.label}
                  </Link>
                ))}
              </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-3">
                <Link to="/collections/marble" className="text-white/45 text-[13px] hover:text-[#b8873d] transition-colors">天然大理石</Link>
                <Link to="/collections/mosaic" className="text-white/45 text-[13px] hover:text-[#b8873d] transition-colors">水刀拼花马赛克</Link>
                <Link to="/collections/furniture" className="text-white/45 text-[13px] hover:text-[#b8873d] transition-colors">石材家具摆件</Link>
                <Link to="/collections/countertop" className="text-white/45 text-[13px] hover:text-[#b8873d] transition-colors">石材台面定制</Link>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="flex flex-col gap-3 text-[13px] text-white/45">
                <p>福建省南安市水头镇惠典工业区</p>
                <p className="text-[#b8873d] font-medium">+86 159 5999 9064</p>
                <p>
                  <a href="mailto:kldstone.china@gmail.com" className="hover:text-[#b8873d] transition-colors">

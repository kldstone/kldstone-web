            ...
            <div>
              ...
              <div className="flex flex-col gap-3 text-[13px] text-[#111111]/45">
                <p className="flex items-center gap-2 text-[#34c759] font-medium">
                  ...
                  <a href="tel:+8615659069988" onClick={() => trackConversion("phone_click", {source:"footer"})}>156 5906 9988</a>
                </p>
                <p className="flex items-center gap-2">
                  ...
                  <a href="mailto:kldstone.china@gmail.com" onClick={() => trackConversion("email_click", {source:"footer"})} className="hover:text-[#34c759] transition-colors">

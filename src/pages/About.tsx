    ...
    <div>
      ...
      <section className="relative h-[55vh] min-h-[420px] bg-[#0f0e0c] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-6">
          <div>
            <span className="text-[#b8873d] text-[11px] font-bold tracking-[0.20em] uppercase">About KLD</span>
      ...
      <section className="max-w-[900px] mx-auto px-6 py-20">
        <span className="text-[#b8873d] text-[11px] font-bold tracking-[0.18em] uppercase block text-center mb-5">
          Our Story
        </span>
      ...
      <section className="bg-[var(--panel)] py-20 px-6">
        <div className="max-w-[1100px] mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <Link
              to="/craftsmanship"
              className="group bg-[var(--bg)] border border-[var(--line)] p-8 hover:border-[#b8873d]/40 transition-colors"
            >
              ...
              <span className="text-[#b8873d] text-[11px] font-bold tracking-[0.08em] uppercase group-hover:tracking-[0.12em] transition-all">
                了解更多 →
              </span>
            </Link>
      ...
      <section className="py-20 px-6 max-w-[1280px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            <span className="text-[#b8873d] text-[11px] font-bold tracking-[0.18em] uppercase">Exhibition</span>
            ...
            <Link
              to="/contact"
              className="inline-block mt-6 text-[var(--gold)] text-[12px] font-bold tracking-[0.08em] border-b border-[#b8873d]/40 pb-1 hover:text-[var(--ink)] transition-colors"
            >
              预约展会见面 →
            </Link>
          </div>

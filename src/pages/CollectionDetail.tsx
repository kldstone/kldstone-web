...
export default function CollectionDetail() {
  ...
  const intro = productCopy[id!] || ["暂无该产品描述信息。"];

  if (!id || !productData[id]) {
    return (
      <div className="min-h-[60vh] flex items-center justify-center">
        <div className="text-center">
          <h1 className="text-2xl font-black text-[#111] mb-4">未找到该产品</h1>
          <Link to="/collections" className="text-[#111] font-bold tracking-[0.06em]">← 返回产品一览</Link>
        </div>
      </div>
    );
  }
    ...
    <div className="bg-white">
      ...
      <section className="relative h-[55vh] min-h-[400px] bg-[#e5e5e5] overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center justify-center text-center px-6">
          <div>
            <span className="text-white/70 text-[11px] font-bold tracking-[0.18em] uppercase">{data.subtitle}</span>
      ...
      <section className="max-w-[1280px] mx-auto px-6 pb-20">
        <div className="text-center mb-14">
          ...
          <h2 className="text-[#111] text-[1.5rem] font-black tracking-[0.03em] mt-2">产品图集</h2>
        </div>
      ...
      <section className="bg-[#f8f8f8] py-20 px-6 border-t border-black/8">
        <div className="max-w-[820px] mx-auto text-center">
          <h2 className="text-[#111] text-[1.5rem] font-black tracking-[0.03em] mb-4">对该产品感兴趣？</h2>
          <p className="text-[#111]/50 text-[14px] mb-8">联系我们获取详细报价与样品</p>
          <Link
            to="/contact"
